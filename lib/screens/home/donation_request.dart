...
import 'component.dart/donation_request.dart';
...
// }
  ...
  _postData() async {
    ...
    // overlay.show();
    try {
      var url = Uri.http(baseUrl, '$baseUrlShow/donation_request.php');
      var uriResponse = await client.post(
        url,
        // headers: ,
        body: {'donation_id': prefs.getInt("donation_id").toString()},
      );
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return DonaterRequestView(
                ...
                add: () {
                  _postAddData(
                      objc.id.toString(),
                      objc.isAccepted == 1 ? "accept" : "donate",
                      objc.isAccepted == 1 ? 2 : 3);
                },
                add1: () {
                  _postAddData(objc.id.toString(), "accept", 4);
                },
                call: () {
